...
const ThemeToggle: FC<{ default?: "light" | "dark" }> = (props) => {

	// get the current theme from local storage
	const [theme, setTheme] = useLocalStorage("theme", props.default ?? "dark");
	...
	return (
		<label className="swap swap-rotate">
			...
			<input type="checkbox" className="theme-controller" onChange={(e) => themeChange(e.target.checked)} checked={theme === "dark"}/>
